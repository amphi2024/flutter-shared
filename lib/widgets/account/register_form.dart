...
class RegisterForm extends StatefulWidget {
  ...
  const RegisterForm({super.key, required this.appWebChannel});
...
class _RegisterFormState extends State<RegisterForm> {
  ...
  void initState() {
    ...
    widget.appWebChannel.getUserIds(onResponse: (list) {
      ids = list;
    }, onFailed: () {
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  if(passwordController.text == confirmPasswordController.text && !ids.contains(idController.text) && passwordController.text.isNotEmpty && usernameController.text.isNotEmpty && idController.text.isNotEmpty) {
                    widget.appWebChannel.register(id: idController.text, name: usernameController.text, password: passwordController.text, onRegistered: () {
